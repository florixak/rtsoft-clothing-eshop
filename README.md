...
Součástí semestrální práce jsou zprávy od 3 testerů, kterým svou práci necháte vyzkoušet. Protože testeři nemusí vědět, co všechno Váš program umí, bude vhodné, abyste jim připravili jedno z následujících:

- Dva až tři úkoly, co mají s Vaším programem provést. Například:
  - nakreslit loď
  - nastavit různým částem jinou barvu
  - uložit obrázek
- Seznam dílčích funkcí, které mají vyzkoušet. Například:
  - otevřít databázi
  - zobrazit detaily záznamu
  - přidat nový záznam
  - upravit datum u jednoho záznamu
  - zobrazit statistiku
  - vykreslit histogram

Tester by pak měl své zkušenosti s používáním programu shrnout v textové podobě do zprávy. Formát ani struktura nejsou předepsané. Pokud tester objeví nedostatky, které by programátor měl opravit, bylo by vhodné je v dokumentu zvýraznit, třeba tučným písmem nebo značkou na okraji.
