...
export const orders: Order[] = [
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-16",
        nameSnapshot: "Elegant Summer Dress",
        selectionSnapshot: { size: "m", color: "beige" },
        quantity: 1,
        priceSnapshot: 1199,
      },
    ],
    ...
    priceDetails: {
      subtotal: 1199,
      shippingCost: 99,
      tax: Math.round(1199 * 0.21),
      total: 1199 + 99 + Math.round(1199 * 0.21),
    },
    status: "paid",
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-17",
        nameSnapshot: "Day Skirt",
        selectionSnapshot: { size: "m", color: "navy" },
        quantity: 2,
        priceSnapshot: 749,
      },
    ],
    customer: {
      ...
      phone: "+420 702 222 333",
    },
    address: {
      street: "Václavské nám. 5",
      city: "Praha",
      postalCode: "110 00",
      country: "CZ",
    },
    ...
    priceDetails: {
      subtotal: 749 * 2,
      shippingCost: 79,
      tax: Math.round(749 * 2 * 0.21),
      total: 749 * 2 + 79 + Math.round(749 * 2 * 0.21),
    },
    status: "pending",
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-18",
        nameSnapshot: "Light Shorts",
        selectionSnapshot: { size: "l", color: "khaki" },
        quantity: 1,
        priceSnapshot: 599,
      },
      {
        productId: "prod-20",
        nameSnapshot: "Simple Swimwear",
    ...
    priceDetails: {
      subtotal: 599 + 899,
      shippingCost: 129,
      tax: Math.round((599 + 899) * 0.21),
      total: 599 + 899 + 129 + Math.round((599 + 899) * 0.21),
    },
    status: "paid",
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-19",
        nameSnapshot: "Utility Overall",
        selectionSnapshot: { size: "l", color: "olive" },
        quantity: 1,
        priceSnapshot: 1899,
      },
    ],
    ...
    priceDetails: {
      subtotal: 1899,
      shippingCost: 129,
      tax: Math.round(1899 * 0.21),
      total: 1899 + 129 + Math.round(1899 * 0.21),
    },
    status: "shipped",
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-20",
        nameSnapshot: "Simple Swimwear",
        selectionSnapshot: { size: "s", color: "blue" },
        quantity: 1,
        priceSnapshot: 899,
      },
    ],
    customer: {
      firstName: "Eva",
      lastName: "Kolarova",
      email: "eva.kolarova@example.cz",
      phone: "+420 601 555 666",
    },
    address: {
      street: "Nerudova 3",
      city: "Český Krumlov",
    ...
    priceDetails: {
      subtotal: 899,
      shippingCost: 79,
      tax: Math.round(899 * 0.21),
      total: 899 + 79 + Math.round(899 * 0.21),
    },
    status: "pending",
  ...
  },
  {
    ...
    updatedAt: "2026-03-25T11:40:00.000Z",
  },
  {
    id: "ord-12",
    userId: "admin-1",
